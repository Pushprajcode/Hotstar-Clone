      ...
      <SafeAreaView style={styles.login}>
        <View>
          ...
          <View style={styles.kid}>
            <View style={{flexDirection: 'row'}}>
              <Text style={{color: '#e7a628'}}>{'KiDS Safe'}</Text>
            </View>
            <Switch
            ...
            <View style={styles.container}>
              <View style={{marginTop: 20}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                  <Image
                    ...
                    source={require('../src/assets/images/download.png')}
                  />
              ...
              <View style={{marginTop: 20}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                  <Image
                    style={{height: 22, width: 22}}
                    source={require('../src/assets/images/file(1).png')}
                  />
                  <View style={styles.channels}>
                    <Text
                      style={{
              ...
              <View style={{marginTop: 20}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                  <Image
                    ...
                    source={require('../src/assets/images/languages.png')}
                  />
                  <View style={styles.channels}>
                    <Text
                      style={{
              ...
              <View style={{marginTop: 20}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                  <Image
                    style={{height: 22, width: 22}}
                    source={require('../src/assets/images/genre.png')}
                  />
                  <View style={styles.channels}>
                    <Text
                      style={{
